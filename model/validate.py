...
def train_valid_split(x_train_set, y_train_set,
    ...
    if config['DL_mode'] == 'classification':
        ...
        net, checkpoint, val_output, train_output, best_fp, best_fn, best_precision, \
        counter, train_losses, val_losses = train_regression(X_train, y_train, X_val, y_val,
                                                network=net, optimizer=opt, loss=loss, lr_scheduler=None,
    ...
    return net, checkpoint, val_output, train_output, best_fp, best_fn, best_precision, counter, train_losses, val_losses